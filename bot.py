...
submission_url = 'https://www.reddit.com/r/BotTown2/comments/r2tf43/aoc_text_thread/'
...
# downvoting others
    for comment in submission.comments.list():
        if 'Bernie Sanders' in comment.body.lower():
            comment.downvote()
            print('Downvoted Bernie Comment')


# downvoting and upoting comments with TextBlob 
    for comment in submission.comments.list():
        blob = TextBlob(str(comment.body))
        polarity = blob.sentiment.polarity
        subjectivity = blob.sentiment.subjectivity

        if 'AOC' in comment.body.lower() and polarity > 0.5:
            comment.upvote()
